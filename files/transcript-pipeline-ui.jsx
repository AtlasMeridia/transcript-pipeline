...
const ResultCard = ({ title, type, content, onView }) => (
  <div style={{
...
export default function TranscriptPipeline() {
  ...
  const simulateProcessing = async () => {
    ...
    setResults({
      ...
      transcript: `[00:00:00] Welcome to this deep dive into transformer architecture...
[00:00:15] Today we'll explore the key innovations that made transformers possible...
[00:01:02] The attention mechanism is really the heart of the transformer...`,
      summary: `This video provides a comprehensive introduction to transformer architecture, the foundation of modern large language models. Key topics include the self-attention mechanism, positional encoding, and the encoder-decoder structure...`,
    });
          ...
          <section style={{
            ...
            <div style={{
              ...
              <ResultCard
                ...
                onView={() => alert('Would open transcript markdown')}
              />
              <ResultCard
                title={results.title}
                type="summary"
                content={results.summary}
                onView={() => alert('Would open summary markdown')}
              />
            </div>
          </section>
        )}
